...
public class Busqueda extends JFrame {
	...
	private void cargarTablaHuesped() {
		...
		// huesped.getId(), huesped.getApellido(),
		// huesped.getNombre(), huesped.getNacimiento().toString(),
	...
	private void cargarTablaReserva() {
		...
		// reservas.forEach(reserva -> modeloReserva.addRow(new Object[] {
		// reserva.getId(),
		// reserva.getIngreso().toString(), reserva.getEgreso().toString(),
		// reserva.getPago(), reserva.getPrecio(),
		// reserva.getHuesped().getApellido() + " " + reserva.getHuesped().getNombre(),
		// reserva.getHuesped().getId() }));
	}
