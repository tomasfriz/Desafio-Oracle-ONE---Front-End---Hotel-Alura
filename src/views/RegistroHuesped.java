...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(Reserva reserva) {
		...
		txtNacionalidad
				.setModel(new DefaultComboBoxModel(new String[] { "Argentina", "Colombia", "Puerto Rico", "España",
		...
		// Inicia la carga y devuelve el id. Queda la conexion abierta esperando el
		// commit
